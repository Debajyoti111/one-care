          ...
          >
            ...
            <Card.Body className="cardly">
              ...
              <Card.Text style={{}}>
                ...
                the bulk of the card's content. dasssssss dasd startDatesa
                dasdsa dasdsa dasdda sdsadasda accessdas dasddaasd accessdasasd
                accessdasasdas dasddaasdas
              </Card.Text>
      ...
      <div className="Parent">
        <div className="profile-container">
          <nav className="patient__nav">
            ...
            <h3>Logged in as: Hospital Name</h3>
          </nav>
